...
//  Verify the price “$15.00”
        Thread.sleep(2000);
        String expectedMessage5 = "$15.00";
        String actualMessage5 = gettextfromelemrnt(By.xpath("//tbody/tr[4]/td[2]"));
...
// Fill the mandatory fields
        ...
        sendtexttoelement(By.xpath("//input[@id='Email']"),"hur6h2@yahoo.com");
...
//   Click on “Returning Customer” tab and fill the mandatory fields
...
// verify the "Register"
        ...
        String expectedMessage7 = "Register";
        String actualMessage7 = gettextfromelemrnt(By.xpath("//h1[contains(text(),'Register')] "));
        Assert.assertEquals("not on Register", expectedMessage7, actualMessage7);

//        fill the mandatory fields
        Thread.sleep(5000);
        clickonelement(By.xpath("//input[@id='gender-male']"));
        sendtexttoelement(By.xpath("//input[@id='FirstName']"),"aline");
        sendtexttoelement(By.xpath("//input[@id='LastName']"),"cat");
        selectbyvaluefromdropdown(By.xpath("//body/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/div[2]/div[4]/div[1]/select[1]"),"20");
        selectbyvaluefromdropdown(By.xpath("//body/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/div[2]/div[4]/div[1]/select[2]"),"12");
        selectbyvaluefromdropdown(By.xpath("//body/div[6]/div[3]/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/div[2]/div[4]/div[1]/select[3]"),"1942");
//email
        sendtexttoelement(By.xpath("//input[@id='Email']"),"Seend1962@dayrep.com");
...
//        verify "Your registration completed"
        ...
        String expectedMessage8 = "Your registration completed";
        String actualMessage8 = gettextfromelemrnt(By.xpath("//div[contains(text(),'Your registration completed')]"));
        Assert.assertEquals("not on Register", expectedMessage8, actualMessage8);
...
//         Fill the Mandatory fields
        ...
        sendtexttoelement(By.xpath("//select[@id='BillingNewAddress_CountryId']"),"Bhutan");
       sendtexttoelement(By.xpath("//input[@id='BillingNewAddress_City']"),"brighton");
       sendtexttoelement(By.xpath("//input[@id='BillingNewAddress_Address1']"),"po1 qa2");
        sendtexttoelement(By.xpath("//input[@id='BillingNewAddress_ZipPostalCode']"),"309091");
        sendtexttoelement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"),"07588771112");
